...
def search_case_law(keywords: str) -> str:
    ...
    Args:
        keywords: Search keywords for case law.
    """
    cases = {
...
QUESTION = (
    "A software vendor intentionally breached a $250,000 contract and the client wants "
    "damages. Which remedies and case law apply?"
)
...
SYSTEM_PROMPT = (
    ...
    "both the legal database and case law before answering. Keep your final answer under 500 words."
)
